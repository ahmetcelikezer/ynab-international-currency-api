...
export class Migration20231204213004 extends Migration {
  ...
  async up(): Promise<void> {
    ...
    this.addSql('create table "accounts" ("id" uuid not null, "email_id" uuid not null, "hashed_password" varchar(255) not null, "last_password_changed_at" timestamptz(0) not null, constraint "accounts_pkey" primary key ("id"));');
